...
Here are some examples of the visualizations generated by the TMS Planner:

### Battery Research Calendar
![Battery Calendar](docs/images/battery_calendar.png)

### Battery Research Calendar (Symposium View)
![Battery Calendar Symposium View](docs/images/battery_calendar_symposium.png)

### Machine Learning Calendar
![ML Calendar](docs/images/ml_calendar.png)

### NVIDIA Profile Calendar (Symposium View)
![NVIDIA Calendar Symposium View](docs/images/nvidia_calendar_symposium.png)

### Viewing HTML Visualizations

The interactive HTML visualizations provide a richer experience than static images. When viewing these on GitHub:

1. **Raw Link**: You can use the "Raw" button on GitHub to get a direct link to the HTML file
2. **GitHub Pages**: If you fork this repository, you can enable GitHub Pages to host the HTML files
3. **HTML Preview**: Use services like [htmlpreview.github.io](https://htmlpreview.github.io/) to view HTML files:
   ```
   https://htmlpreview.github.io/?https://github.com/yourusername/tms-planner/blob/main/examples/battery_calendar.html
   ```
4. **Local Download**: For the best experience, clone the repository and open the HTML files locally
